	...
	<div id="header">
		...
		<div class="nav_2">
			...
			<div class="nub">
                ...
                <div class="cub"><b><p>四</p></b></div>
                <div class="cub"><b><p>五</p></b></div>
                <div class="cub"><b><p>六</p></b></div>
                <div class="cub"><b><p>七</p></b></div>
                <div class="cub"><b><p>八</p></b></div>
			</div>
		</div>
		<div class="nav_3">
...
$sql = "select * from fucai order by date desc limit 52";
...
foreach($data as $row){
	...
	echo "<tr><td><p style='color:#000;'>$row[1]</p></td><td><b><p style='color:red;'>$row[2]</p></b></td><td><b><p style='color:red;'>$row[3]</p></b></td><td><b><p style='color:red;'>$row[4]</p></b></td><td><p style='color:#000;'>$row[5]</p></td><td><p style='color:#000;'>$row[6]</p></td><td><p style='color:#000;'>$row[7]</p></td><td><p style='color:#000;'>$row[8]</p></td><td><p style='color:#000;'>$row[9]</p></td></tr>";
}
echo '</tr>';
...
?>
				...
				<li style="width:66%;float:right;">
<!-- 走势图 -->
<?php
$sql ="select date,num_1,num_2,num_3,num_4,num_5,num_6,num_7,num_8 from fucai order by date desc  limit 52";
