...
<head>
	<title>知了彩票</title>
	<meta charset="UTF-8">
	<link rel="stylesheet" type="text/css" href="style_0225.css">
	...
	<div id="header">
        ...
        <div class="nav_new"><span><b><p>任&nbsp;&nbsp;&nbsp;&nbsp;选&nbsp;&nbsp;&nbsp;&nbsp;值&nbsp;&nbsp;&nbsp;&nbsp;走&nbsp;&nbsp;&nbsp;&nbsp;势</p></b></span></div>
			...
			<ul>
            	...
            	<li style="float:left; background:#6D6D6D;">
						<p>二</p>
            	</li>
            	<li style="float:left; background:#fff;">
						<p>三</p>
...
$sql = "select * from ticai_1215 order by date desc limit 44";
...
<!-- 走势图 -->
<?php 
$sql ="select date,num_1,num_2,num_3,num_4,num_5 from ticai order by date desc  limit 44";
...
include_once("../tool.php");
$sql ="select date,num_1,num_2,num_3,num_4,num_5 from ticai_1215 order by date desc  limit 44";
