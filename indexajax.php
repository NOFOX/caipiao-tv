...
//$sql = "select id,date,num_1,num_2,num_3,num_4,num_5,num_6,num_7,num_8 from fucai ";
...
<script type="text/javascript">
	for(var i=0; i<70; i++){
			$('#myTable1').append("<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>/tr>");
	}
</script>
<?php
exit;
