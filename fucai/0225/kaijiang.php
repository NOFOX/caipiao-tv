...
foreach($data as $row){
	...
	echo "<tr><td>$row[1]</td><td style='color:red;font-weight:bold'>$row[2]</td><td style='color:red;font-weight:bold'>$row[3]</td><td style='color:red;font-weight:bold'>$row[4]</td><td>$row[5]</td><td>$row[6]</td><td>$row[7]</td><td>$row[8]</td><td>$row[9]</td></tr>";
}
echo '</tr>';
