...
foreach($data as $row){
	...
	echo "<tr><td>$row[1]</td><td class='bold-red'>$row[2]</td><td class='bold-red'>$row[3]</td><td class='bold-red'>$row[4]</td><td>$row[5]</td><td>$row[6]</td><td>$row[7]</td><td>$row[8]</td><td>$row[9]</td></tr>";
}
echo '</tr>';
echo "</table>";
// @mysql_close($dbh);
