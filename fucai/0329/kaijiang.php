...
<body>
	<div id="header">
		...
		<div class="nav_2">
			...
			<div class="nub">
				<div class="cub"><b><p style="font-size:20px;">一</p></b></div>
                <div class="cub"><b><p style="font-size:20px;">二</p></b></div>
                <div class="cub"><b><p style="font-size:20px;">三</p></b></div>
...
$sql = "select * from fucai_1215 order by date desc limit 60";
...
foreach($data as $row){
	...
	echo "<tr><td><p style='color:#000;'>$row[1]</p></td><td><b><p style='color:red;'>$row[2]</p></b></td><td><b><p style='color:red;'>$row[3]</p></b></td><td><b><p style='color:red;'>$row[4]</p></b></td><td><b><p style='color:#000;'>$row[5]</p></b></td><td><b><p style='color:#000;'>$row[6]</p></b></td><td><b><p style='color:#000;'>$row[7]</p></b></td><td><b><p style='color:#000;'>$row[8]</p></b></td><td><b><p style='color:#000;'>$row[9]</p></b></td></tr>";
}
echo '</tr>';
...
?> 
				...
				<li style="width:65%;float:right;">
<!-- 走势图 -->
<?php 
$sql ="select date,num_1,num_2,num_3,num_4,num_5,num_6,num_7,num_8 from fucai_1215 order by date desc  limit 60";
/* 定义变量q, "SELECT * FROM abc"是一个SQL语句,意思是读取表abc中的数据 */  
$rs = mysql_query($sql, $dbh); 
/* 定义变量 rs ,函数mysql_query()的意思是:送出 query 字串供 MySQL 做相关的处理或者执行.由于php是从右往左执行的,所以,rs的值是服务器运行mysql_query()函数后返回的值 */ 
if(!$rs){die("Valid result!");} 
