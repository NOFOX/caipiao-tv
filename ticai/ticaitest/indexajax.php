...
$sql ="select * from ticai order by date desc  limit 71";
...
foreach($data as $row){
	...
	echo "<tr><td><p style='color:#000;'>$row[1]</p></td><td><b><p style='color:red;'>$row[2]</p></b></td><td><b><p style='color:red;'>$row[3]</p></b></td><td><b><p style='color:red;'>$row[4]</p></b></td><td><p style='color:#000;'>$row[5]</p></td><td><p style='color:#000;'>$row[6]</p></td></tr>";
}
echo '</tr>';
for($i=1;$i<=70;$i++){
   echo "<tr><td><p></p></td><td><p></p></td><td><p></p></td><td><p></p></td><td><p></p></td><td><p></p></td></tr>";
}
exit;
